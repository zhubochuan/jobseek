...
@section('content')
<!---This page is used to edit job---->
@foreach($jobs as $job)

<form action="{{route('updatejobpage',$job['id'])}}" method="POST">
    {{ csrf_field() }}
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="job_title" name="job_title" required value="{{$job['title']}}">
    </div>
    <br>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="job_location" id="location" name="location" value="{{$job['location']}}">
    ...
    <div class="form-group purple-border">
        ...
        <textarea class="form-control" id="job_description" rows="3" required name="job_des" id="job_des">{{$job['description']}}</textarea>
    </div>
    <br>
    ...
    <br>
    <br>
    <button type="submit" class="btn btn-info" style="float: left;">Update</button>
...
<form action="{{ route('deletejob',['id'=>$job['id']]) }}" method="post">
    {{ csrf_field() }}
    {{ method_field('DELETE') }}
    <button type="submit" class="btn btn-danger" style="float: left; margin-left:10px;">Delete</button>
</form>
