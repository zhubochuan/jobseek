                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="is_employer" id="is_employer" value="1">

                                    <label class="form-check-label" for="is_employer">
                                        I am an employer
                                    </label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input placeholder="Business name" id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
